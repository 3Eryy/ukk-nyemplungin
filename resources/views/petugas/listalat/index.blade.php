    ...
    <div class="p-6 bg-white min-h-screen font-sans">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="border rounded-xl p-6 shadow-sm bg-white relative">
                ...
                <p class="text-xs text-gray-500">Total semua alat yang dipinjam</p>
            </div>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="py-4 px-4">
                                    <div class="flex gap-2">
                                        ...
                                        {{-- button delete --}}
                                        <form action="{{ route('petugas.equipments.delete', $equip->id) }}" method="POST"
    ...
    <div id="addEquipmentModal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title"
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
                ...
                <form action="{{ route('petugas.equipments.insert') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <div id="editModal-{{ $item->id }}" class="fixed inset-0 z-50 hidden overflow-y-auto"
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <!-- Form Update -->
                    <form action="{{ route('petugas.equipments.update', $item->id) }}" method="POST"
